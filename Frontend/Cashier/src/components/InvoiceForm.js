...
class InvoiceForm extends React.Component {
        ...
        render() {
            return ( < Form onSubmit = { this.openModal } >
                ...
                div class = "mb-2" >
                <
                span className = "fw-bold" > Current & nbsp; Date: & nbsp; < /span> <
                ...
                <
                span className = "fw-bold d-block me-2" > Due & nbsp; Date: < /span> <
                ...
                div className = "d-flex flex-row align-items-center" >
                <
                span className = "fw-bold me-2" > Invoice & nbsp; Number: & nbsp; < /span> <
                ...
                Form.Control placeholder = { "Who is this invoice from?" }
                rows = { 3 }
                ...
                Form.Control placeholder = { "Who is this invoice to?" }
                rows = { 3 }
                ...
                /Col> <
                /Row> <
                InvoiceItem onItemizedItemEdit = { this.onItemizedItemEdit.bind(this) }
                ...
                span >
                <
                span className = "small " > ({ this.state.discountRate || 0 } % ) < /span> { this.state.currency } { this.state.discountAmmount || 0 } < /span> <
                /div> <
                div className = "d-flex flex-row align-items-start justify-content-between mt-2" >
                <
                ...
                span >
                <
                span className = "small " > ({ this.state.taxRate || 0 } % ) < /span> { this.state.currency } { this.state.taxAmmount || 0 } < /span> <
                /div> <
                hr / >
                <
                div className = "d-flex flex-row align-items-start justify-content-between"
                ...
                Form.Control placeholder = "Thank you for doing business with us!"
                name = "notes"
                ...
                type = "submit"
                className = "d-block w-100 btn-secondary" > Review Invoice < /Button> <
                ...
                InputGroup className = "my-1 flex-nowrap" >
                <
                Form.Control name = "discountRate"
                type = "number"
